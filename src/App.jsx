  ...
  const services = [
    {
      ...
      title: "Forros",
      description:
        "Forros de alta qualidade para transformar e melhorar o ambiente, combinando estética, funcionalidade e durabilidade.",
      features: [
        "Isolamento térmico",
        "Acabamento perfeito",
        "Instalação rápida",
    ...
    },
    {
      ...
      title: "Divisórias",
      description:
        "Divisórias versáteis e elegantes, projetadas para otimizar espaços com eficiência e estilo.",
    ...
    },
    {
      ...
      title: "Gesso 3D",
      description:
        "Gesso 3D para interiores que redefine a estética dos espaços com texturas e relevos sofisticados.",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-white mb-8 leading-relaxed">
                ...
                qualidade superior e acabamento impecável para residências e
                empresas.
              </p>
              <div className="hidden md:flex flex-col sm:flex-row gap-4">
                ...
                >
                  <Button
                    size="lg"
                    className="bg-orange-600/40 hover:bg-orange-700 text-white px-8 py-4 text-lg"
                  >
                    Solicitar Orçamento
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Soluções completas em gesso e drywall com a mais alta qualidade e
              design inovador
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                A M&M Construção transforma espaços com sua expertise em design
                e acabamentos de alto padrão. Cada projeto reflete inovação,
                qualidade e beleza.
              </p>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Transformar ambientes através de soluções criativas e de
                      alta qualidade em gesso.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Ser referência nacional em design de interiores com gesso,
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Integridade, inovação constante, respeito mútuo e
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-orange-100 max-w-3xl mx-auto">
                Na M&M Construção Designer e Acabamentos, economize sem abrir
                mão da qualidade. Oferecemos soluções que combinam eficiência
                financeira com acabamento impecável.
              </p>
            </motion.div>
                      ...
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="revestimento">
                              Revestimento Gesso Liso
                            </SelectItem>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Transformando espaços com elegância e sofisticação através de
                soluções inovadoras em gesso e drywall.
              </p>
